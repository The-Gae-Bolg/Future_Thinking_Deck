...
<html lang="en">
  <head>
    ...
    <title>Deck Future Thinking</title>
  </head>
  <body>
        ...
        <div class="row mt-4">
          ...
          <div class="col-lg align-self-center intro intro-video">
            <div class="heading-img">
              <img class="video-block" src="img/iStock-1305960650.jpg" alt="video" />
              ...
              <div class="modal fade" id="diagnosticoModal" tabindex="-1" aria-labelledby="diagnosticoModalLabel" aria-hidden="true">
                <div class="modal-dialog mw-75">
                  <div class="modal-content">
                    ...
                    <div data-tf-widget="HFnYn3q3" data-tf-iframe-props="title=Diagnostico INICIO Future Thinking" data-tf-medium="snippet" style="width:100%;height:400px;"></div><script src="//embed.typeform.com/next/embed.js"></script>
                    </div>
                  </div>
                </div>
              </div>
